...
| created_at                                                  | Date                                                     |
| updated_at                                                  | Date                                                     |
| payment_status (shown when not using invoice integration)   | String (UNPAID, PARTIALLY_PAID, PAID, OVERDUE)           |
| xero_status (shown when using Xero integration)             | String                                                   |
| quickbooks_status (shown when using Quickbooks integration) | String                                                   |
| economic_status (shown when using e-conomic integration)    | String                                                   |
