...
| duplicate_allocations             | Boolean (Defaults to true). Determines if allocations on the project should be duplicated                                                     |
| duplicate_retainer_periods        | Boolean (Defaults to true). Determines if retainer periods on the project should be duplicated                                                |
| duplicate_placeholders            | Boolean (Defaults to true). Determines if placeholders on the project should be duplicated                                                    |
| duplicate_placeholder_allocations | Boolean (Defaults to true). If `duplicate_placeholders` is true, this determines if placeholder allocations on the project should be duplicated |
